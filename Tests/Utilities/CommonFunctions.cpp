...
namespace Allocation::Tests
{
        ...
        Poco::Data::Session& session, std::string batchRef, std::string sku, int qty, int version)
    {
        ...
        session << "INSERT INTO public.batches (reference, sku, purchased_quantity, eta) VALUES "
                   "($1, $2, $3, NULL)",
            Poco::Data::Keywords::use(batchRef), Poco::Data::Keywords::use(sku),
            Poco::Data::Keywords::use(qty), Poco::Data::Keywords::now;

        int id = 0;
        session << "SELECT id FROM public.batches WHERE reference = $1 AND sku = $2",
            Poco::Data::Keywords::into(id), Poco::Data::Keywords::use(batchRef),
            Poco::Data::Keywords::use(sku), Poco::Data::Keywords::now;
        ...
        Poco::Data::Session& session, std::string orderid, std::string sku)
    {
        ...
        selectOrderLine << "SELECT id FROM public.order_lines WHERE orderid = $1 AND sku = $2",
            Poco::Data::Keywords::use(orderid), Poco::Data::Keywords::use(sku),
            Poco::Data::Keywords::into(orderlineId), Poco::Data::Keywords::now;
        ...
        selectBatchRef << R"(
            ...
            Poco::Data::Keywords::use(orderlineId), Poco::Data::Keywords::into(batchref),
            Poco::Data::Keywords::now;
