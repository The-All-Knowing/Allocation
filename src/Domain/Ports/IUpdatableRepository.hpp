...
namespace Allocation::Domain
{
    ...
    /// (optimistic locking), что позволяет обнаруживать и предотвращать конфликты параллельных изменений.
    /// Используется, например, в TrackingRepository или в рамках Unit of Work.
